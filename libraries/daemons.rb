...
class Chef::Resource
  ...
  class SystemdJournald < Chef::Resource::SystemdDaemon
    resource_name :systemd_journald if respond_to?(:resource_name)
  ...
  class SystemdLogind < Chef::Resource::SystemdDaemon
    resource_name :systemd_logind if respond_to?(:resource_name)
  ...
  class SystemdResolved < Chef::Resource::SystemdDaemon
    resource_name :systemd_resolved if respond_to?(:resource_name)
  ...
  class SystemdTimesyncd < Chef::Resource::SystemdDaemon
    resource_name :systemd_timesyncd if respond_to?(:resource_name)
