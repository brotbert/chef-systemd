...
class Chef::Resource
  ...
  class SystemdAutomount < Chef::Resource::SystemdUnit
    resource_name :systemd_automount if respond_to?(:resource_name)
  ...
  class SystemdMount < Chef::Resource::SystemdUnit
    resource_name :systemd_mount if respond_to?(:resource_name)
  ...
  class SystemdPath < Chef::Resource::SystemdUnit
    resource_name :systemd_path if respond_to?(:resource_name)
  ...
  class SystemdService < Chef::Resource::SystemdUnit
    resource_name :systemd_service if respond_to?(:resource_name)
  ...
  class SystemdSlice < Chef::Resource::SystemdUnit
    resource_name :systemd_slice if respond_to?(:resource_name)
  ...
  class SystemdSocket < Chef::Resource::SystemdUnit
    resource_name :systemd_socket if respond_to?(:resource_name)
  ...
  class SystemdSwap < Chef::Resource::SystemdUnit
    resource_name :systemd_swap if respond_to?(:resource_name)
  ...
  class SystemdTarget < Chef::Resource::SystemdUnit
    resource_name :systemd_target if respond_to?(:resource_name)
  ...
  class SystemdTimer < Chef::Resource::SystemdUnit
    resource_name :systemd_timer if respond_to?(:resource_name)
